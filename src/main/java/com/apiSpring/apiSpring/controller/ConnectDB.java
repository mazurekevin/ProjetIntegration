...
public class ConnectDB {
    public String connectDB(String request, String method) {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://b02fc6a68294e9:375284d6@eu-cdbr-west-02.cleardb.net/heroku_3673ffd1e5cd834?reconnect=true","b02fc6a68294e9","b02fc6a68294e9");
